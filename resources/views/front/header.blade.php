        ...
        <div class="col-md-4 col-lg-6 text-center">
            <div class="position-relative ps-4">
                <div class="d-flex border rounded-pill">
                    <input class="form-control border-0 rounded-pill w-100 py-3" type="text" placeholder="What are you looking for?">
        ...
        <div class="col-md-4 col-lg-3 text-center text-lg-end">
            <div class="d-inline-flex align-items-center">
                ...
                <a href="{{ route('cart.index') }}" class="text-muted d-flex align-items-center justify-content-center">
                    ...
                    <span class="text-dark ms-2">My Cart</span>
                </a>
